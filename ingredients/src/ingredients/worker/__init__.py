...
This package owns the *runtime* + the seam contracts; the pipeline stages (built
later, gated on RecipeGF v0.4.0) register their ``stage_fn`` bodies into
``dispatch.STAGE_FNS``. Everything here is exercised with fake providers / fake
stage_fns — never a live model.
