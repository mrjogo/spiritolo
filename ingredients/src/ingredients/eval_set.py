...
_PARSE_CASES: list[EvalCase] = [
    ...
    EvalCase("1 lemon", "thekitchn",
             ...
             expect_amount=1.0, expect_unit="each", expect_name="lemon"),
    EvalCase("2 limes", "thekitchn",
             expect_status="parsed", expect_rule="qty_known_noun",
             expect_amount=2.0, expect_unit="each", expect_name="lime"),
    EvalCase("1 banana", "punch",
             expect_status="parsed", expect_rule="qty_known_noun",
             expect_amount=1.0, expect_unit="each", expect_name="banana"),
    EvalCase("1 large lemon", "foodandwine",
             expect_status="parsed", expect_rule="qty_known_noun",
             expect_amount=1.0, expect_unit="each", expect_name="lemon"),
    EvalCase("2 ripe peaches", "seriouseats",
             expect_status="parsed", expect_rule="qty_known_noun",
             expect_amount=2.0, expect_unit="each", expect_name="peach"),
    EvalCase("4 whole star anise", "diffordsguide",
             expect_status="parsed", expect_rule="qty_known_noun",
             expect_amount=4.0, expect_unit="each", expect_name="star anise"),
    ...
    EvalCase("4 fresh raspberries", "foodandwine",
             expect_status="parsed", expect_rule="qty_known_noun",
             expect_amount=4.0, expect_unit="each", expect_name="raspberry"),
    EvalCase("12 small jalapeños", "seriouseats",
             expect_status="parsed", expect_rule="qty_known_noun",
             expect_amount=12.0, expect_unit="each", expect_name="jalapeño"),
