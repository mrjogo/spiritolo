...
def derive_name(recipe: dict) -> str | None:
    """Pull a display name off a Schema.org Recipe dict, unwrapping list forms."""
...
def derive_author(recipe: dict) -> str | None:
    """Pull an author name, flattening the bare-string / Person-object / list forms."""
...
def derive_image_url(recipe: dict) -> str | None:
    """Pull an image URL, flattening the string / ImageObject / list forms."""
