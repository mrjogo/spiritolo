"""One-time HTML corpus loader: gzip + write-once upload to R2, keyed
sha256(url), plus the ``pages.r2_key`` backfill.
...
operator-run, not a pipeline stage: see docs/upload.md-style runbooks for how
